package com.dmm.oauth.controller;


import com.dmm.common.pojo.Result;
import com.dmm.common.pojo.StatusCode;
import com.dmm.oauth.service.LoginService;
import com.dmm.oauth.util.AuthToken;
import com.dmm.oauth.util.CookieUtil;
...
public class UserLoginController {
    ...
    public Result login(String username, String password) {
        ...
        return new Result(StatusCode.OK,true, "令牌生成成功",authToken);
    }
